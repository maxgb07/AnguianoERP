...
function obtenerServiciosEnProceso()
{
   ...
   $.ajax({
            ...
            data: "accion=obtener&finalizado="+1,
            async: false,
            dataType: "json",
            success: function(datos) {
             ...
             var data ='';
               $.each(datos.data, function(i, item) {
                  ...
                  data+='<td>'+item.fecha_fin_servicio+'</td>';
                  data+='<td>'+item.descripcion_servicio+'</td>';
                  data+='<td>'+item.placas_vehiculo+'</td>';
                  data+='<td>'+item.km_vehiculo+'</td>';
                  data+='<td>'+item.unidad_vehiculo+'</td>';
