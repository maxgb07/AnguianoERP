...
<body class="nav-md">
    ...
    <!-- Modal para Finalizar Servicio -->
                  <div class="modal fade bs-example-modal-lg" id="finalizarServicio" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
	...
	<script type="text/javascript" src="js/serviciosfinalizado.js"></script>
  </body>
 </html> 
<?php
}else
